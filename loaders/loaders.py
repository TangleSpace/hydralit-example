...
def pulse_bars():
    ...
    spinner_div = """
        <div class="labelbox"><h1>{loader_text}</h1><br></div>
        <div class="parent">
...
def get_loader(loader_name):
    ...
    if loader_name == Loaders.points_line:
        ...
        return pacman_loader()
    elif loader_name == Loaders.showcase2:
        return showcase2()
    elif loader_name == Loaders.showcase:
        return showcase()
    else:
        return pulse_bars()


class hydralit_spinner:
    ...
    def __init__(self, text='', loader_name=None, height=256):
        #styles = self.build_style()

        height_str = '{}{}'.format(str(height),'px')

        loader_div, loader_style = get_loader(loader_name)
        self.element_code = loader_div.format(loader_text=text)
